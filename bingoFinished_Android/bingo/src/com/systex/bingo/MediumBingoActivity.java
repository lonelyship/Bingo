...
public class MediumBingoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mediumbingo);
	...
	public void init() {
		...
		tvLines = (TextView) findViewById(R.id.MtextView1);
		tvLines.setText(getString(R.string.lines) + ":"

		+ ((Integer) currentLines).toString());

		gameModeSwitch = (Switch) findViewById(R.id.MSwitch1);
		...
		imgBingo = (ImageView) findViewById(R.id.MimgBingo);

		btns = new Button[16];

		btns[0] = (Button) findViewById(R.id.MButton01);
		btns[1] = (Button) findViewById(R.id.MButton02);
		btns[2] = (Button) findViewById(R.id.MButton03);
		btns[3] = (Button) findViewById(R.id.MButton04);
		btns[4] = (Button) findViewById(R.id.MButton05);
		btns[5] = (Button) findViewById(R.id.MButton06);
		btns[6] = (Button) findViewById(R.id.MButton07);
		btns[7] = (Button) findViewById(R.id.MButton08);
		btns[8] = (Button) findViewById(R.id.MButton09);
		btns[9] = (Button) findViewById(R.id.MButton10);
		btns[10] = (Button) findViewById(R.id.MButton11);
		btns[11] = (Button) findViewById(R.id.MButton12);
		btns[12] = (Button) findViewById(R.id.MButton13);
		btns[13] = (Button) findViewById(R.id.MButton14);
		btns[14] = (Button) findViewById(R.id.MButton15);
		btns[15] = (Button) findViewById(R.id.MButton16);

		btnRandom = (Button) findViewById(R.id.MButtonRandom);
		btnInit = (Button) findViewById(R.id.MButtonInit);
		...
		shortClickListener = new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				else
				{
					...
					int row = indexOfPressedButton / 4;
					int col = indexOfPressedButton % 4;
...

	{
		...
		seek.setProgress(seekBarTempProgress - 16);

		popDialog.setTitle(getString(R.string.selectmaxrange) + "16~50");
		...
		seek.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
			...
			public void onProgressChanged(SeekBar seekBar, int progress,
				...
				txtSeek.setText(getString(R.string.maxrange) + (progress + 16));

				seekBarTempProgress = progress + 16;
